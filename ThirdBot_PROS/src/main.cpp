...
int8_t LEFT_ROLLER_PORT = 1;
int8_t RIGHT_ROLLER_PORT = 2;
int8_t TILTER_1_PORT = 3;
int8_t TILTER_2_PORT = 4;
int8_t LEFT_FRONT_DRIVE_PORT = 5;
int8_t LEFT_BACK_DRIVE_PORT = 6;
int8_t RIGHT_FRONT_DRIVE_PORT = 7;
int8_t RIGHT_BACK_DRIVE_PORT = 8;
...
Motor driveFR(RIGHT_FRONT_DRIVE_PORT, false, AbstractMotor::gearset::green, AbstractMotor::encoderUnits::degrees);
Motor driveBR(RIGHT_BACK_DRIVE_PORT, false, AbstractMotor::gearset::green, AbstractMotor::encoderUnits::degrees);
